    ...
    <c:param name="content">
        ...
        <table>
            <tbody>
                ...
                <tr>
                    <th>出勤時刻</th>
                    <td><pre><c:out value="${attendance.timeIn}" /></pre></td>
                </tr>
                <tr>
                    <th>出勤退勤</th>
                    <td><pre><c:out value="${attendance.timeOut}" /></pre></td>
                </tr>
                <tr>
                    <th>体温</th>
                    <td><pre><c:out value="${attendance.bodyTemperature}" /></pre></td>
                </tr>
                <tr>
                    <th>登録日時</th>
                ...
                <tr>
                    <th>更新日時</th>
                    <fmt:parseDate value="${attendance.updatedAt}" pattern="yyyy-MM-dd'T'HH:mm:ss" var="updateDay" type="date" />
